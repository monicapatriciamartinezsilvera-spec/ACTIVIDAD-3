...
class Vehiculo{
  ...
  void mostrarInfo(){
    print('Marca: ${this.marca}, Modelo: ${this.modelo}, Año: ${this.anio}, Estado: ${this._estado}');
  }
...
class Carro extends Vehiculo{
  ...
  Carro(String marca, String modelo, int anio, int numeroPuertas):super(marca, modelo, anio: anio){
...
class Motocicleta extends Vehiculo{
  ...
  Motocicleta(String marca, String modelo, int anio, int cilindraje):super(marca, modelo, anio: anio){
